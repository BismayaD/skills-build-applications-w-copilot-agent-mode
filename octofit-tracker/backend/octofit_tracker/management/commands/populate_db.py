...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Clear existing data in correct order to avoid FK issues (delete individually for Djongo)
        ...
        w2 = Workout.objects.create(name='Flight Training', description='Aerobic and flight skills', difficulty='Medium')
